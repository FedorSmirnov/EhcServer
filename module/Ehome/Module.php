...
class Module
{
                ...
                'factories' => array(
                        ...
                        'JobaEventTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new JobaEvent());
                            return new TableGateway('jobaevent', $dbAdapter, 
                        ...
                        'RoomTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new Room());
                            return new TableGateway('room', $dbAdapter, null, 
                                    $resultSetPrototype);
                        },
                        'Ehome\Entity\ApiTable' => function  ($sm)
                        {
    ...
    public function onBootstrap ($e)
    {
        $events = $e->getApplication()
            ->getEventManager()
            ->getSharedManager();
        $events->attach('ZfcUser\Form\Login', 'init', 
                function  ($e)
                {
                    $form = $e->getTarget();
