...
// 		}
		...
		$moduleFiles = array(
				...
				//"module/Ehome/src/Ehome/Controller/BackendController.php",
				...
				"module/Ehome/src/Ehome/Form/Login.php",
				"module/Ehome/src/Ehome/Form/RoomForm.php",
				"module/Ehome/view/ehome/backend/index.phtml",
				"module/Ehome/view/ehome/backend/login.phtml",
				...
				"module/Ehome/view/zfc-user/user/index.phtml",
